...
Version: 2.0.1 -> 2.1.0
Modified Principles:
- Service Guardrails – Runtime Stack now mandates Spring Boot Starter scaffolding for every service module
Added Sections:
- None
Removed Sections:
- None
Templates:
- None (no collateral updates required)
Follow-ups:
- None
-->
...
**Version**: 2.1.0 | **Ratified**: 2025-11-22 | **Last Amended**: 2025-11-29
