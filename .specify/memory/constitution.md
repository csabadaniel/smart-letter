...
Modified Principles:
- Service Guardrails: Cloud Run timeout guidance now distinguishes the hard 60s cap from the 5s p95 operational target to align with plan-template performance goals
Added Sections:
- None
Removed Sections:
- None
...
**Version**: 1.10.2 | **Ratified**: 2025-11-22 | **Last Amended**: 2025-11-23
