...
Version: 1.7.0 → 1.8.0
Modified Principles:
- Service guardrails now mandate automated GitHub Actions deployments per environment with quality gates
Added Sections:
- Workflow gate for continuous delivery evidence and promotion policy
Removed Sections:
- None
Templates:
...
**Version**: 1.8.0 | **Ratified**: 2025-11-22 | **Last Amended**: 2025-11-23
